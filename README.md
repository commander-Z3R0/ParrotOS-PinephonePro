...
* Ideal for **pentesting on-the-go**, development, or as a daily privacy-first mobile OS.

---

## Installation

1. Download the latest image (link coming soon).
2. Flash the image to an SD card or internal storage using a tool such as `dd` or **Balena Etcher**.
3. Insert the SD card into your PinePhone Pro or boot from internal storage.
4. Follow the initial setup prompts.
...
* PinePhone Pro
* SD card (recommended: 16GB or larger) or internal storage
